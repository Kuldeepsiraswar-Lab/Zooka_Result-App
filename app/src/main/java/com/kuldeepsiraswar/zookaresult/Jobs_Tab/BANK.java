 ...
 */
public class BANK extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    public WebView mWebView;
    private SwipeRefreshLayout swipeRefreshLayout;
    public static BANK newInstance(int position) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mWebView.loadUrl("https://zookaresult.in/app/bank-jobs/");
