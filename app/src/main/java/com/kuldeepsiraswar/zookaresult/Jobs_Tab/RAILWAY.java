 ...
 */
public class RAILWAY extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    public WebView mWebView;
    private SwipeRefreshLayout swipeRefreshLayout;
    public static RAILWAY newInstance(int position) {
        RAILWAY fragment = new RAILWAY();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mWebView.loadUrl("https://zookaresult.in/app/railway-jobs/");
