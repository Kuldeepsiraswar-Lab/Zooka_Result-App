 ...
 */
public class UPSC extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    public WebView mWebView;
    private SwipeRefreshLayout swipeRefreshLayout;
    public static UPSC newInstance(int position) {
        UPSC fragment = new UPSC();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mWebView.loadUrl("https://zookaresult.in/app/upsc-jobs/");
