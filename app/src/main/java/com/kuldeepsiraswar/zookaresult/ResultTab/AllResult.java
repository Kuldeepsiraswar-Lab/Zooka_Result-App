 ...
 */
public class AllResult extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    public WebView mWebView;
    private SwipeRefreshLayout swipeRefreshLayout;
    public static AllResult newInstance(int position) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mWebView.loadUrl("https://zookaresult.in/app/result/");
